...
\begin{table}[h]
  ...
  \begin{tabular}{l ccc ccc ccc}
      ...
      \midrule
      NeRD & 23.48 & 0.126 & 0.889 & 25.83 & 0.097 & 0.824 & 23.69 & 0.163 & 0.812 \\
      nvdiffrecmc & 25.71 & 0.094 & 0.908 & 26.43 & 0.089 & 0.916 & 25.31 & 0.127 & 0.824 \\
      \textbf{Ours} & \textbf{29.54} & \textbf{0.055} & \textbf{0.945} & \textbf{29.67} & \textbf{0.058} & \textbf{0.966} & \textbf{26.67} & \textbf{0.086} & \textbf{0.891} \\
      \bottomrule
  \end{tabular}
...
\begin{table}[h]
  ...
  \begin{tabularx}{\textwidth}{l *{12}{>{\centering\arraybackslash}X}}
      \toprule
      & \multicolumn{4}{c}{Metallic} & \multicolumn{4}{c}{Specular} & \multicolumn{4}{c}{Blinn-Phong} \\
      \cmidrule(lr){2-5} \cmidrule(lr){6-9} \cmidrule(lr){10-13}
      & PSNR & LPIPS& SSIM & CD & PSNR & LPIPS & SSIM & CD & PSNR & LPIPS & SSIM & CD\\
      \midrule
      w/o SANL & 28.36 & 0.071 & 0.934 & 7.44 & 28.45 & 0.073 & 0.927 & 7.21 & 26.96 & 0.086 & 0.919 & 6.97\\
      \textbf{w/ SANL} & \textbf{29.87} & \textbf{0.054} & \textbf{0.954} & \textbf{6.32} & \textbf{29.60} & \textbf{0.055} & \textbf{0.949} & \textbf{6.43} & \textbf{29.16} & \textbf{0.057} & \textbf{0.934} & \textbf{6.85} \\
      \bottomrule
    \end{tabularx}
  \label{tab:sanl_quan}
\end{table}
